...
class Cubemap(private val deviceUtil: VulkanDeviceUtil) {
    ...
    private fun createPipeline(descriptorSetLayout: DescriptorSetLayout) {
        val vertexShader = ClassLoader.getSystemResource("shaders/surroundsound/cubemap/cubemap_vert.spv").readBytes()
        val fragmentShader = ClassLoader.getSystemResource("shaders/surroundsound/cubemap/cubemap_frag.spv").readBytes()
    ...
    fun destroy() {
        ...
        this.pipeline.destroy(deviceUtil.device)
    }
}